...
class Trainer(nn.Module):
    def __init__(self, config):
        ...
        self.classifier = prob_res50(is_prob=True).eval()
#         self.classifier = VGG()
        # Optimizers
    ...
    def initialize(self, vgg_dir):
        ...
        vgg_state_dict = vgg_state_dict['net_state_dict']
    ...
    def random_age(self, age_input, diff_val=40):
    ...
    def gen_encode(self, x_a, age_a, age_b=0, training=False, target_age=0):
        if target_age:
            ...
            age_modif = self.random_age(age_a, diff_val=40)
...
#         predict_age_pb = F.softmax(predict_age_pb, dim=1)
        # Get predicted age
